"""
   ...
   1) read(n) --> it is used to read a specified number of bytes of data from a file
                  ...
                  points for read():
                      1) it returns string in binary mode
                      ...
                      5) while reading it includes '\n' and spaces as part of the string
...
""" for read() """
# modes
ob4 = open("bin_file_8.dat",'rb')
print("ob4.read(): ");print(ob4.read(),'\n')

ob5 = open("bin_file_8.dat",'rb+')
print("ob5.read(): ");print(ob5.read(),'\n')

ob6 = open("bin_file_8.dat",'ab+') # in this, the pointer goes to the ending of the file, so, there is no thing to print  
print("ob6.read(): ");print(ob6.read(),'\n')

ob7 = open("bin_file_9.dat",'wb+') # in this, the content will be lost. Enter anything in bin_file_9 and run it then the whole content will be lost
print("ob7.read(): ");print(ob7.read(),'\n')
print("....................................................................\n\n")

# pointer movement
ob8 = open("bin_file_8.dat",'rb')
content1 = ob8.read()
content2 = ob8.read()
print("for ob8: ")
print("content1: ")
...
ob12 = open("bin_file_8.dat",'rb')
content1 = ob12.read(20)
content2 = ob12.read(100000)
print("for ob12: ")
print("content1: ")
print(content1)
# after execution of content1, the pointer goes to 20th character, then the remaining content will be print in content2
print("content2: ")
print(content2,'\n')

ob13 = open("bin_file_8.dat",'rb')
content1 = ob13.read(10)
content2 = ob13.read()
print("for ob13: ")
print("content1: ")
print(content1)
...
ob14 = open("bin_file_8.dat",'rb')
content1 = ob14.read(20)
content2 = ob14.read(10)
print("for ob14: ")
print("content1: ")
print(content1)
# after execution of content1, the pointer goes to the 20th characters, then the content from 21th char to 30th char will be print in content2
print("content2: ")
print(content2,'\n')
print("....................................................................\n\n")
...
""" for readline() """
# modes
ob15 = open("bin_file_8.dat",'rb')
print("ob15.readline(): ");print(ob15.readline(),'\n')

ob16 = open("bin_file_8.dat",'rb+')
print("ob16.readline(): ");print(ob16.readline(),'\n')

ob17 = open("bin_file_8.dat",'ab+') # in this, the pointer goes to the ending of the file, so, there is no thing will be printed
print("ob17.readline(): ");print(ob17.readline(),'\n')

ob18 = open("bin_file_9.dat",'wb+') # in this, the content will be lost. Enter anything in bin_file_9.dat and run it then the whole content will be lost
print("ob18.readline(): ");print(ob18.readline(),'\n')
print("....................................................................\n\n")

# pointer movement
ob19 = open("bin_file_8.dat",'rb')
...
""" for readlines()"""
# modes
ob28 = open("bin_file_8.dat",'rb')
print("ob28.readlines(): ");print(ob28.readlines(),'\n')

ob29 = open("bin_file_8.dat",'rb+')
print("ob29.readlines(): ");print(ob29.readlines(),'\n')

ob30 = open("bin_file_8.dat",'ab+') # in this, the pointer goes to the ending of the file, so, there is no thing will be printed
print("ob30.readlines(): ");print(ob30.readlines(),'\n')

ob31 = open("bin_file_9.dat",'wb+') # in this, the content will be lost. Enter anything in bin_file_9.dat and run it then the whole content will be lost
print("ob31.readlines(): ");print(ob31.readlines(),'\n')
print("....................................................................\n\n")

# pointer movement
ob32 = open("bin_file_8.dat",'rb')
...
ob36 = open("bin_file_8.dat",'rb')
content1 = ob36.readlines(20)
...
ob37 = open("bin_file_8.dat",'rb')
content1 = ob37.readlines(20)
content2 = ob37.readlines(25)
print("for ob37: ")
print("content1: ")
print(content1)
...
ob38 = open("bin_file_8.dat",'rb')
content1 = ob38.readlines(20)
...
with open("bin_file_8.dat",'rb') as object1:
    content1 = object1.read()
    print("object1.read: ")
    print(content1,'\n')

with open("bin_file_8.dat",'rb') as object2:
    content2 = object2.readline()
    print("object2.read: ")
    print(content2,'\n')

with open("bin_file_8.dat",'rb') as object3:
...
with open('bin_file_8.dat','rb') as object:
...
with open('bin_file_8.dat','rb') as object:
    ...
    print('content1:' )
    for i in content1: print(chr(i),end=",")
print('\n') 
print("....................................................................\n\n")
